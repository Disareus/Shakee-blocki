...
* **Zero-Allocation Architecture:** Powered by Fastutil primitive long maps (`Long2ObjectOpenHashMap`), generating zero Garbage Collection overhead during animations.
...
Shakee Blocki is fully configurable in-game via **Mod Menu** and **Cloth Config**:
